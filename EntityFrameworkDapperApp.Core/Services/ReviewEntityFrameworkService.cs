...
public sealed class ReviewEntityFrameworkService : IReviewEntityFrameworkService
{
    private readonly IReviewEntityFrameworkRepository _repository;

    public ReviewEntityFrameworkService(IReviewEntityFrameworkRepository repository)
    {
